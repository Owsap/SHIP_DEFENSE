...
namespace ShipDefense
{
	...
	enum EVNumHelper : DWORD
	{
		...
		SHIP_MAST = 20434, // ±âµÕµÀ
		SHIP_WHEEL = 20436, // Á¶Å¸´ë
		...
		HYDRA_LEFT = 3963, // È÷µå¶ó(left)
		HYDRA_RIGHT = 3964, // È÷µå¶ó(right)

		MINI_HYDRA1 = 3957, // ¹Ì´ÏÈ÷µå¶ó1
		MINI_HYDRA2 = 3958, // ¹Ì´ÏÈ÷µå¶ó2
		MINI_HYDRA3 = 3959, // ¹Ì´ÏÈ÷µå¶ó3

		HYDRA_EGG = 20432, // È÷µå¶ó¾Ë
		HYDRA_REWARD = 3965, // È÷µå¶óº¸»ó

		PORTAL = 3949, // Æ÷Å»

		WOOD_REPAIR = 20437, // ¼ö¸®ÆÐÅ¶
	};
